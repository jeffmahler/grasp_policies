...
class b2Separator(object):
    """Proxy of C++ b2Separator class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        """__init__(b2Separator self) -> b2Separator"""
        _Box2D.b2Separator_swiginit(self,_Box2D.new_b2Separator())

    def Separate(self, pBody, pFixtureDef, pVerticesVec, scale):
        """Separate(b2Separator self, b2Body pBody, b2FixtureDef pFixtureDef, vector< b2Vec2 > * pVerticesVec, int scale)"""
        return _Box2D.b2Separator_Separate(self, pBody, pFixtureDef, pVerticesVec, scale)


    def Validate(self, verticesVec):
        """Validate(b2Separator self, vector< b2Vec2 > const & verticesVec) -> int"""
        return _Box2D.b2Separator_Validate(self, verticesVec)

    __swig_destroy__ = _Box2D.delete_b2Separator
b2Separator.Separate = new_instancemethod(_Box2D.b2Separator_Separate, None, b2Separator)
b2Separator.Validate = new_instancemethod(_Box2D.b2Separator_Validate, None, b2Separator)
b2Separator_swigregister = _Box2D.b2Separator_swigregister
b2Separator_swigregister(b2Separator)
